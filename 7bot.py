...
admin = ["ua900e1ba4a91a01b7de658f26471c510ua5246fb6c9e7fce0cf982776298b709b","u4c10b3d699545a706d87eb8002ac49c5","u67c43239c865dfce6addb41c6b3c0edd","uc216d8664c4e1f43772c98b1b0b8956e","u29971676114806a574c148f0df876c22","u24d44be70c40b45eaee0818821bee579"]
...
adminMID = "ua900e1ba4a91a01b7de658f26471c510ua5246fb6c9e7fce0cf982776298b709b","u4c10b3d699545a706d87eb8002ac49c5","u67c43239c865dfce6addb41c6b3c0edd","uc216d8664c4e1f43772c98b1b0b8956e","u29971676114806a574c148f0df876c22","u24d44be70c40b45eaee0818821bee579"
wait = {
    'protect':False,
    'protectinv':False,
    'protectqr':False,
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V1]")
                ki.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V2]")
                kk.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V3]")
                kc.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V4]")
                kd.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V5]")
                ke.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V6]")
                kf.sendText(msg.to,"ˢˡᵒʷᵉʳ ᵇᵒᵗ[V7]")
#-----------------------------------------------
...
def autolike():
    ...
    if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try: 
            ...
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ㄩㄗ大神")
